...
class StoreGhLanguageResultsRepository{
    ...
    public function update(StoreResultsRequest $storeResultsRequest): JsonResponse
    {
        if ($storeResultsRequest) {
            ...
            $result = new gh_language(); // Create an instance of the results class
    ...
    private function recalculatePositions()
    {
        ...
        $students = gh_language::orderBy('Total_Score', 'desc')->get();
