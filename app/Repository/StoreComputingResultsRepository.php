...
class StoreComputingResultsRepository{
    ...
    public function update(StoreResultsRequest $storeResultsRequest): JsonResponse
    {
        if ($storeResultsRequest) {
            ...
            $result = new computing(); // Create an instance of the results class
    ...
    private function recalculatePositions()
    {
        ...
        $students = computing::orderBy('Total_Score', 'desc')->get();
