...
class StoreFrenchResultsRepository{
    ...
    public function update(StoreResultsRequest $storeResultsRequest): JsonResponse
    {
        if ($storeResultsRequest) {
            ...
            $result = new french(); // Create an instance of the results class
    ...
    private function recalculatePositions()
    {
        ...
        $students = french::orderBy('Total_Score', 'desc')->get();
