...
class StoreSocialStudiesResultsRepository{
    ...
    public function update(StoreResultsRequest $storeResultsRequest): JsonResponse
    {
        if ($storeResultsRequest) {
            ...
            $result = new socialstd(); // Create an instance of the results class
    ...
    private function recalculatePositions()
    {
        ...
        $students = socialstd::orderBy('Total_Score', 'desc')->get();
