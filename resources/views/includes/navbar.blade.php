<nav class="navbar navbar-expand-lg navbar-dark bg-dark col-lg-12 col-12 p-0 fixed-top py-3"
    style="background: linear-gradient(to right, #201e3a, #b2b3be);">
    ...
    <div class="container d-flex justify-content-between">
        <a class="navbar-brand ml-auto" href="#">
            ...
            <h4 class="mb-0" style="color: #ffff; font-weight: bold; display: inline-block;">ACCRA INSTITUE OF TECHNOLOGY</h4>
        </a>

        <div class="ml-auto">
            <div class="d-flex ml-auto">
                <!-- Card for displaying today's date in a specific timezone -->
                <div class="card text-white ml-2" style="background: #27595a">
                    <div class="card-body">
                        @php
        ...
        <div class="card text-white ml-auto" style="background: #27595a">
